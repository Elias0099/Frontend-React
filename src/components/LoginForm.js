...
export default class LoginForm extends React.Component {
    ...
    onSubmitRegister = (e) => {
        this.state.onRegister(e, this.state.nombre, this.state.apellido, this.state.login, this.state.password);
    };
                    ...
                    <div className="tab-content">
                        ...
                        <div className={classNames("tab-pane", "fade", this.state.active === "register" ? "show active" : "")} id="pills-register" >
                            <form onSubmit={this.onSubmitRegister}>
                                ...
                                <div className="form-outline mb-4">
                                    <input type="text" id="nombre" name="nombre" className="form-control" onChange={this.onChangeHandler}/>
                                    <label className="form-label" htmlFor="nombre">Nombres</label>
                                </div>

                                <div className="form-outline mb-4">
                                    <input type="text" id="apellido" name="apellido" className="form-control" onChange={this.onChangeHandler}/>
